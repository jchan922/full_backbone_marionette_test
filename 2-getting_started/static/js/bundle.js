...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(10), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
(function(root, factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(1), __webpack_require__(9), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
with(obj||{}){
__p+='\r\n<!-- Form Template -->\r\n    <!-- form.js LayoutView will automatically creating wrapping <form> tags around the below elements -->\r\n\r\n<label for="id_text">Todo Text</label>\r\n<input type="text" name="text" id="id_text" value="'+
((__t=( text ))==null?'':_.escape(__t))+
'">\r\n<label for="id_assignee">Assign To</label>\r\n<input type="text" name="text" id="id_assignee" value="'+
